...
def language_eval(dataset, preds, model_id, split):
    ...
    if 'ucm' in dataset:
        annFile = '/data/zsp/RSIC/dataset/UCM_captions/dataset_cocoformat.json'
    elif 'coco' in dataset:
        annFile = 'coco-caption/annotations/captions_val2014.json'
    elif 'RSICD' in dataset:
        annFile = '/data/zsp/RSIC/dataset/RSICD/dataset_rsicd_cocoformat.json'
    elif 'flickr30k' in dataset or 'f30k' in dataset:
        annFile = 'coco-caption/f30k_captions4eval.json'
    elif 'sydney' in dataset:
        annFile = '/data/zsp/RSIC/dataset/Sydney_captions/dataset__cocoformat.json'
