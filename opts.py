...
def parse_opt():
    ...
    parser.add_argument('--alpha', type=float, default=0.28,
                    help='strong match threshold')
    parser.add_argument('--beta', type=float, default=0.26,
                    help='weak match threshold')
    parser.add_argument('--unlabel_fraction', type=float, default=1.0,
                    help='dataset fraction for semi-supervised learning')
    parser.add_argument('--ablation', type=int, default=0,
                    help='start Ablation Study')
    ...
    parser.add_argument('--gamma', type=int, default=3,
                    help='epoch to start unsupervised train')
    parser.add_argument('--num_token', type=int, default=1,
                    help='the num of selected token')
    parser.add_argument('--clip_feat_path', type=str, default="/data/zsp/RSIC/MG-Transformer-main/dataset/clip_feature/sydney_224",
                    help='epoch to start unsupervised train')
